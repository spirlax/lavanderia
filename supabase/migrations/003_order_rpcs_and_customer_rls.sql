...
security invoker
set search_path = ''
as $function$ select * from private.create_platform_order( p_customer_id, p_scheduled_for, p_items, p_operation_id ); $function$;
...
security invoker
set search_path = ''
as $function$ select * from private.transition_order_status( p_order_id, p_to_status, p_operation_id, p_reason ); $function$;
